...
\begin{figure}[h]
    \center{\includegraphics[scale=0.5]{logical-model.png}}
...
\multicolumn{1}{|c|}{\textbf{Название}} & \multicolumn{1}{c|}{\textbf{Описание}} & \textbf{Тип данных} & \textbf{Ограничение} & \textbf{PK} & \textbf{FK} \\ \hline
id & Уникальный ключ & SERIAL & NOT NULL & + &  \\ \hline
maintainer\_id & id соотв. мэйнтенера & INT & NOT NULL &  & + \\ \hline
...
license\_nm & Лицензия, под которой распространяется & VARCHAR(16) & NOT NULL &  &  \\ \hline
\end{tabular}%
}
...
\multicolumn{1}{|c|}{\textbf{Название}} & \multicolumn{1}{c|}{\textbf{Описание}} & \textbf{Тип данных} & \textbf{Ограничение} & \textbf{PK} & \textbf{FK} \\ \hline
id & Уникальный ключ & SERIAL & NOT NULL & + &  \\ \hline
maintainer\_id & id соотв. мэйнтейнера & INT & NOT NULL &  & + \\ \hline
...
\multicolumn{1}{|c|}{\textbf{Название}} & \multicolumn{1}{c|}{\textbf{Описание}} & \textbf{Тип данных} & \textbf{Ограничение} & \textbf{PK} & \textbf{FK} \\ \hline
id & Уникальный ключ & SERIAL & NOT NULL & + &  \\ \hline
package\_id & id соотв. пакета & INT & NOT NULL &  & + \\ \hline
...
source\_id & Внешний ключ сущности исходный код & INT &  &  & + \\ \hline
\end{tabular}%
}
...
is\_default\_flag & Поставляется ли пакет при базовой установкe & BOOLEAN & NOT NULL, DEFAULT FALSE  &  &  \\ \hline
\end{tabular}%
}
...
\multicolumn{1}{|c|}{\textbf{Название}} & \multicolumn{1}{c|}{\textbf{Описание}} & \textbf{Тип данных} & \textbf{Ограничение} & \textbf{PK} & \textbf{FK} \\ \hline
id & Уникальный ключ & SERIAL & NOT NULL & + &  \\ \hline
package\_id & Внешний ключ пакета & INT &  & & + \\ \hline
group\_id & Внешний ключ группы пакетов & INT &  & & + \\ \hline
\end{tabular}%
}
